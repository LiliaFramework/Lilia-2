...
function SKIN:PaintListViewLine(panel, w, h)
    surface.SetDrawColor((panel:IsHovered() or panel:IsLineSelected()) and lia.config.Get("color", lia.color.white) or lia.color.transparent)
    surface.DrawRect(0, 0, w, h)
end
